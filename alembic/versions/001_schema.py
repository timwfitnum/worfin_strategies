...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("contract_type",   sa.String(10), nullable=False),   # "front", "second", "cash", "3m"
        ...
        sa.Column("source",          sa.String(50),  nullable=False),   # "nasdaq_data_link", "ibkr", "yfinance"
        sa.Column("fetched_at",      sa.DateTime(timezone=True), nullable=False),
        sa.Column("created_at",      sa.DateTime(timezone=True), server_default=sa.text("NOW()"), nullable=False),
        schema="raw_data",
    )
    op.create_index("ix_raw_futures_ticker_ts", "futures_prices", ["ticker", "price_timestamp"], schema="raw_data")
    ...
    op.create_index("ix_raw_inventory_ticker_ts", "lme_inventory", ["ticker", "report_timestamp"], schema="raw_data")
    ...
    op.create_index("ix_clean_prices_ticker_ts", "continuous_prices", ["ticker", "price_timestamp"], schema="clean_data")
    op.create_index("ix_clean_prices_bar_size",  "continuous_prices", ["bar_size"], schema="clean_data")
    ...
    op.create_index("ix_clean_term_ticker_ts", "term_structure", ["ticker", "price_timestamp"], schema="clean_data")
    ...
    op.create_index("ix_clean_vol_ticker_ts", "realised_vol", ["ticker", "computed_at"], schema="clean_data")
    ...
    op.create_index("ix_signals_strategy_ticker_ts", "computed_signals", ["strategy_id", "ticker", "computed_at"], schema="signals")
    op.create_index("ix_signals_valid_until",        "computed_signals", ["valid_until"], schema="signals")
    op.create_index("ix_signals_frequency",          "computed_signals", ["frequency", "bar_size"], schema="signals")
    ...
    op.create_table(
        ...
        sa.Column("strategy_id",     sa.String(4),  nullable=False),
        sa.Column("ticker",          sa.String(4),  nullable=False),
        sa.Column("order_type",      sa.String(20), nullable=False),   # "limit_passive", "limit_aggressive", "market"
        ...
        sa.Column("status",          sa.String(20), nullable=False),   # "pending", "filled", "cancelled", "rejected"
        sa.Column("created_at",      sa.DateTime(timezone=True), server_default=sa.text("NOW()"), nullable=False),
        schema="orders",
    )
    ...
    op.create_table(
        ...
        sa.Column("event_type",      sa.String(50), nullable=False),   # "startup", "kill_switch", "circuit_breaker"
        sa.Column("severity",        sa.String(20), nullable=False),   # "info", "warning", "critical", "kill"
    ...
    op.create_table(
        ...
        sa.Column("ticker",          sa.String(4),  nullable=True),
        sa.Column("flag_type",       sa.String(50), nullable=False),   # "staleness", "outlier", "price_discrepancy"
